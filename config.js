...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/a977c54af76efc743dcc3.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    PMB: process.env.PMB || '_Evening messages not allowed_😡,_idiot BLOCKED!_',
    READ_COMMAND: convertToBool(process.env.READ_COMMAND) || true,
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~a5cc851c015c993402eb55bb005b0b30:3158327441344b486167383d').trim() || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '254758732775-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'Maldives;Mak;0;https://telegra.ph/file/a977c54af76efc743dcc3.jpg;https://whatsapp.com/channel/0029VaWrCuH35fLuVP2iCc2R',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '254,233,234',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '*',
    STICKER_DATA: process.env.STICKER_DATA || "MALDII",
    BOT_NAME: process.env.BOT_NAME || 'MAK🌻',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭MALDIVES¹¹ꫂ;KING M  bot;https://telegra.ph/file/a977c54af76efc743dcc3.jpg' : process.env.AUDIO_DATA,
