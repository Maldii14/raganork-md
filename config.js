...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/41e729814bfe07cabf04f.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    PMB: process.env.PMB || '_Evening messages not allowed,idiot BLOCKED!_',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Vinta;Vivian;0;https://telegra.ph/file/41e729814bfe07cabf04f.jpg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '254,233,234',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Vinta",
    BOT_NAME: process.env.BOT_NAME || 'vinta🌻',
